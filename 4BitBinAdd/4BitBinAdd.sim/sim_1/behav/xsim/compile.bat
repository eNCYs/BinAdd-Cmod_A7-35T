...
REM
REM Generated by Vivado on Tue Apr 18 20:23:15 +0100 2023
...
echo "xvlog --incr --relax -prj BinAdd4Bit_tb_vlog.prj"
call xvlog  --incr --relax -prj BinAdd4Bit_tb_vlog.prj -log xvlog.log
