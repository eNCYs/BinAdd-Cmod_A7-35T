...
REM
REM Generated by Vivado on Sun Apr 16 06:00:26 +0100 2023
...
echo "xvlog --incr --relax -prj BinAdd_tb_vlog.prj"
call xvlog  --incr --relax -prj BinAdd_tb_vlog.prj -log xvlog.log
